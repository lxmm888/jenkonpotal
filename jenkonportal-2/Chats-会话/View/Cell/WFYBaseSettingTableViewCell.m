//
//  WFYDBaseSettingTableViewCell.m
//  RCloudMessage
//
...
@interface WFYBaseSettingTableViewCell()
...
@implementation WFYBaseSettingTableViewCell
...
- (void)setImageView:(UIImageView *)imageView ImageStr:(NSString *)imageStr imageSize:(CGSize)imageSize LeftOrRight:(NSInteger)LeftOrRight{
  ...
  if (imageStr != nil) {
    if ([imageStr hasPrefix:@"http"] || [imageStr hasPrefix:@"file:"]) {
      [imageView sd_setImageWithURL:[NSURL URLWithString:[imageStr WFYURLString]] placeholderImage:nil];
    } else {
