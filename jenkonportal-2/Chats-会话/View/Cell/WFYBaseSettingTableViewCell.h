 ...
 */
@protocol WFYBaseSettingTableViewCellDelegate <NSObject>
...
@interface WFYBaseSettingTableViewCell : UITableViewCell
...
@property(weak, nonatomic) id<WFYBaseSettingTableViewCellDelegate>
