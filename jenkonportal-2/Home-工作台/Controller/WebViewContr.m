...
@interface WebViewContr ()<WKNavigationDelegate,WKUIDelegate,UINavigationControllerDelegate>
...
- (void)bindUIValue
{
    ...
    [_webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[_url WFYURLString]]]];
    //[_webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.baidu.com"]]];
    //http://123.207.57.57:8034/manage/Work/LeaveProcedure/LeaveProcedureCreate?loginId=%@
//    NSString *openUrl = [NSString stringWithFormat:@"http://123.207.57.57:8034/manage/Work/LeaveProcedure/WorkIndex?loginId=%@",[RCIM sharedRCIM].currentUserInfo.userId];
...
- (void)layoutUI
{
    ...
    CGFloat webViewTopMargin = 0;//kStatusBarH+kNaviBarH;
    CGFloat webViewH = sh-(kStatusBarH+kNaviBarH)-kToolBarH, webViewY = webViewTopMargin;
